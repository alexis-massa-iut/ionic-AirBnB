...
/* harmony default export */ __webpack_exports__["default"] = ("<ion-app>\n  <ion-menu side=\"start\">\n    <ion-header>\n      <ion-toolbar>\n        <ion-title>\n          monBnB\n        </ion-title>\n      </ion-toolbar>\n    </ion-header>\n    <ion-content>\n      <ion-list>\n        <ion-menu-toggle>\n          <ion-item routerLink=\"/places/tabs/discover\">\n            <ion-icon name=\"business\" slot=\"start\"></ion-icon>\n            <ion-label>Endroits à Découvrir</ion-label>\n          </ion-item>\n        </ion-menu-toggle>\n        <ion-menu-toggle>\n          <ion-item routerLink=\"/bookings\">\n            <ion-icon name=\"checkbox-outline\" slot=\"start\"></ion-icon>\n            <ion-label>Mes Réservations</ion-label>\n          </ion-item>\n        </ion-menu-toggle>\n        <ion-menu-toggle>\n          <ion-item routerLink=\"/places/tabs/offers/new\">\n            <ion-icon name=\"add-outline\" slot=\"start\"></ion-icon>\n            <ion-label>Créer offre</ion-label>\n          </ion-item>\n        </ion-menu-toggle>\n        <ion-menu-toggle>\n          <ion-item routerLink=\"/places/tabs/offers\">\n            <ion-icon name=\"list-outline\" slot=\"start\"></ion-icon>\n            <ion-label>Mes offres</ion-label>\n          </ion-item>\n        </ion-menu-toggle>\n        <ion-menu-toggle>\n          <ion-item (click)=\"onLogout()\" button>\n            <ion-icon name=\"exit\" slot=\"start\"></ion-icon>\n            <ion-label>Déconnexion</ion-label>\n          </ion-item>\n        </ion-menu-toggle>\n      </ion-list>\n    </ion-content>\n  </ion-menu>\n  <ion-router-outlet main></ion-router-outlet>\n</ion-app>");
...
var routes = [
    ...
    { path: 'auth', loadChildren: function () { return __webpack_require__.e(/*! import() | auth-auth-module */ "auth-auth-module").then(__webpack_require__.bind(null, /*! ./auth/auth.module */ "./src/app/auth/auth.module.ts")).then(function (m) { return m.AuthPageModule; }); } },
    {
        path: 'places',
        loadChildren: function () { return __webpack_require__.e(/*! import() | places-places-module */ "places-places-module").then(__webpack_require__.bind(null, /*! ./places/places.module */ "./src/app/places/places.module.ts")).then(function (m) { return m.PlacesPageModule; }); },
        canLoad: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]]
    },
    {
        path: 'bookings',
        loadChildren: function () { return Promise.all(/*! import() | bookings-bookings-module */[__webpack_require__.e("common"), __webpack_require__.e("bookings-bookings-module")]).then(__webpack_require__.bind(null, /*! ./bookings/bookings.module */ "./src/app/bookings/bookings.module.ts")).then(function (m) { return m.BookingsPageModule; }); },
        canLoad: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]]
    }
];
...
/* harmony import */ var _angular_common_locales_fr__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/common/locales/fr */ "./node_modules/@angular/common/locales/fr.js");
/* harmony import */ var _angular_common_locales_fr__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_angular_common_locales_fr__WEBPACK_IMPORTED_MODULE_10__);
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            entryComponents: [],
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"]],
            providers: [
                ...
                { provide: _angular_core__WEBPACK_IMPORTED_MODULE_0__["LOCALE_ID"], useValue: 'fr' // 'de' for Germany, 'fr' for France ...
                }
            ],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm5/core.js");
/* harmony import */ var _users_users_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../users/users.service */ "./src/app/services/users/users.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AuthService = /** @class */ (function () {
    function AuthService(usersService) {
        ...
        this._userAuthenticated = ""; // Id of connected user (used for bookings)
    }
    ...
    AuthService.ctorParameters = function () { return [
        { type: _users_users_service__WEBPACK_IMPORTED_MODULE_1__["UsersService"] }
    ]; };
    AuthService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
            providedIn: 'root'
        }),
        __metadata("design:paramtypes", [_users_users_service__WEBPACK_IMPORTED_MODULE_1__["UsersService"]])
    ], AuthService);
    return AuthService;
}());
...
/* harmony import */ var src_app_model_user_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/model/user.model */ "./src/app/model/user.model.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var UsersService = /** @class */ (function () {
    function UsersService(toastController) {
    ...
    UsersService.prototype.getUserById = function (id) {
        ...
        return allUsers ? allUsers.find(function (user) { return user.id === id; }) : null;
    };
    /**
     * Get user from localStorage
     */
    UsersService.prototype.getUserByUsername = function (username) {
        var allUsers = this.getAllUsers();
        if (allUsers)
            return allUsers.find(function (user) { return user.username === username; });
        else
            return null;
    };
    /**
     ...
     */
    UsersService.prototype.createUser = function (username, password) {
        //Create id
        var id = (1).toString();
        do {
        ...
        if (!this.getUserById(id) && !this.getUserByUsername(username)) { // If user doesn't exist already
            var user = new src_app_model_user_model__WEBPACK_IMPORTED_MODULE_2__["User"](id, username, password);
...
module.exports = __webpack_require__(/*! D:\LocalRepository\ionic-AirBnB\src\main.ts */"./src/main.ts");

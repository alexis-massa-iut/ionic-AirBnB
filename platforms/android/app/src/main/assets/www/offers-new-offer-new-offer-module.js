...
/* harmony import */ var src_app_services_photo_photo_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/services/photo/photo.service */ "./src/app/services/photo/photo.service.ts");
/* harmony import */ var src_app_services_places_places_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/services/places/places.service */ "./src/app/services/places/places.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NewOfferPage = /** @class */ (function () {
    function NewOfferPage(photoService, placesServices, router) {
   ...
   */
    ...
    NewOfferPage.prototype.onCreateOffer = function () {
        ...
        var newPlace = new src_app_model_place_model__WEBPACK_IMPORTED_MODULE_3__["Place"]('', this.formOffer.value.title, this.formOffer.value.description, this.image, this.formOffer.value.price);
        this.placesServices.addPlace(newPlace);
        this.formOffer.reset();
        this.router.navigate(['/places/tabs/offers']);
    };
    NewOfferPage.ctorParameters = function () { return [
        { type: src_app_services_photo_photo_service__WEBPACK_IMPORTED_MODULE_4__["PhotoService"] },
        { type: src_app_services_places_places_service__WEBPACK_IMPORTED_MODULE_5__["PlacesService"] },
    ...
    NewOfferPage = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_services_photo_photo_service__WEBPACK_IMPORTED_MODULE_4__["PhotoService"],
            src_app_services_places_places_service__WEBPACK_IMPORTED_MODULE_5__["PlacesService"],

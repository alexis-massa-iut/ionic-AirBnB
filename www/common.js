...
var Place = /** @class */ (function () {
    function Place(id, title, description, imageUrl, price, personal) {
        this.id = id;
        this.title = title;
...
var PlacesService = /** @class */ (function () {
    function PlacesService() {
        this._places = [
            new _place_model__WEBPACK_IMPORTED_MODULE_1__["Place"]('p1', 'Chalet Cartusien', 'The place to be.', 'https://a0.muscache.com/im/pictures/miso/Hosting-23976121/original/0832bc7e-8c9f-45a5-ba50-d82db5dbf2e9.jpeg?im_w=720', 219.99, true),
            new _place_model__WEBPACK_IMPORTED_MODULE_1__["Place"]('p2', 'Pension Manhattan', 'Au coeur de New York.', 'https://lonelyplanetimages.imgix.net/mastheads/GettyImages-538096543_medium.jpg?sharp=10&vib=20&w=1200', 149.99, false),
            new _place_model__WEBPACK_IMPORTED_MODULE_1__["Place"]('p3', 'L\'Amour Toujours', 'Endroit romantique à Paris.', 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/Paris_Night.jpg/1024px-Paris_Night.jpg', 189.99, true),
            new _place_model__WEBPACK_IMPORTED_MODULE_1__["Place"]('p4', 'Palace des Brumes', 'Le fog de San Francisco.', 'https://upload.wikimedia.org/wikipedia/commons/0/01/San_Francisco_with_two_bridges_and_the_fog.jpg', 99.99, false),
            new _place_model__WEBPACK_IMPORTED_MODULE_1__["Place"]('p5', 'Datcha Moscovite', 'A 2 pas de la place rouge.', 'http://linguarik.com/wp-content/uploads/2019/10/1-datcha-bf0a0-f8c7a.jpg', 119.99, false)
        ];
    }
    Object.defineProperty(PlacesService.prototype, "otherPlaces", {
        get: function () {
            return __spreadArrays(this._places.filter(function (p) { return !p.personal; }));
        },
        enumerable: true,
        configurable: true
    });
    PlacesService.prototype.getPlace = function (id) {
        return __assign({}, this._places.find(function (p) { return p.id === id; }));
    };
    Object.defineProperty(PlacesService.prototype, "myPlaces", {
        get: function () {
            return __spreadArrays(this._places.filter(function (p) { return p.personal; }));
        },
        enumerable: true,

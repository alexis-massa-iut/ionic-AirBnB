...
var routes = [
    ...
    {
        path: 'bookings',
        loadChildren: function () { return __webpack_require__.e(/*! import() | bookings-bookings-module */ "bookings-bookings-module").then(__webpack_require__.bind(null, /*! ./bookings/bookings.module */ "./src/app/bookings/bookings.module.ts")).then(function (m) { return m.BookingsPageModule; }); },
        canLoad: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]]
    }
];
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.login = function (username, password) {
        if (this.usersService.getUserByUsername(username) && this.usersService.getUserByUsername(username).password === password) {
            ...
            this.userAuthenticated = this.usersService.getUserByUsername(username).id;
        }
    };
...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.getUserById = function (id) {
        ...
        if (allUsers)
            return allUsers.find(function (user) { return user.id === id; });
        else
            return null;
    };
    /**
